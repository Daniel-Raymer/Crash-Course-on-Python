...
#students arrived, and then Jamie took over. After the class,
#they each entered their lists into the computer and emailed them to the professor,
...
def combine_lists(list1, list2):
    ...
    newlist = list(reversed(list2)) + list2
    return newlist
